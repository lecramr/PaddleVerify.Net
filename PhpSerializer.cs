...
namespace PaddleVerify.Net
{
    class PhpSerializer
    {
        ...
        public string Serialize(object obj)
        {
            ...
            this.seenSortedDicts = new Dictionary<SortedDictionary<string, dynamic>, bool>();
        ...
        private StringBuilder serialize(object obj, StringBuilder sb)
        {
            ...
            {
                if (this.seenSortedDicts.ContainsKey((SortedDictionary<string, dynamic>)obj))
                    return sb.Append("N;");//cycle detected
                else
                    this.seenSortedDicts.Add((SortedDictionary<string, dynamic>)obj, true);
